...
})({"dpcih":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
var _countdownDefault = parcelHelpers.interopDefault(_countdown);
var _forms = require("./forms");
var _numberInput = require("./numberInput");
// init count Down
_countdownDefault.default("Jan 14, 2023 13:00:00");
setTimeout(()=>{
    _forms.loader.classList.add("hidden");
}, 1000); // target elements
 // forms
 // timer
 // animation
 // guests icons
 // timer
 // forms SubmitEvent. event defautl
 // gust

},{"./countdown":"b5xVp","./forms":"207Ed","./numberInput":"dSmTV","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"b5xVp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"207Ed":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function handleForm(e) {
    ...
    for(let i = 0; i < inputs.length; i++){
        const el = inputs[i];
        if (el.name) {
            if (el.type !== 'radio' || el.checked) body[el.name] = el.value;
        }
    }
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dSmTV":[function(require,module,exports) {
...
let number = '';
const minValue = 1, maxValue = 10, step = 1;
function handleMath(e) {
    if (number === '') updateNumber(String(minValue));
    else {
        let n = Number(number);
...
},{}]},["dpcih","iWSTb"], "iWSTb", "parcelRequire9bc7")
